...
describe('PermissionsComponent', () => {
    ...
    const MockPermissionsRichTableHelperService = {
    ...
    beforeEach(async(() => {
        TestBed.configureTestingModule({
            declarations: [PermissionsComponent, RichTableStubComponent],
            providers: [
                { provide: Store, useValue: MockStore },
                { provide: PermissionsRichTableHelperService, useValue: MockPermissionsRichTableHelperService }
            ]
        })
        .compileComponents();
    }));
